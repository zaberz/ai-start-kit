...
function FicusRevenuePage() {
  ...
  const periodTotalReal = filteredOrders.reduce((s, o) => s + (o.real_price || 0), 0);
  const periodTotalOriginal = filteredOrders.reduce((s, o) => s + (o.total_price || 0), 0);
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">按顾问和月份查看营业额数据</p>
      </div>
